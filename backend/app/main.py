...
from .routers import anexos, busca, calendario, categorias, contas_fixas, dashboard, entradas, ia, metas, push, variaveis
...
for r in (categorias.router, contas_fixas.router, variaveis.router, entradas.router, metas.router, dashboard.router, busca.router, anexos.router, calendario.router, ia.router, push.router):
