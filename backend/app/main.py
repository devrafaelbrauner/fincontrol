...
from .routers import analises, anexos, busca, calendario, categorias, contas_fixas, dashboard, entradas, ia, metas, orcamentos, push, variaveis
...
for r in (categorias.router, contas_fixas.router, variaveis.router, entradas.router, metas.router, dashboard.router, analises.router, busca.router, orcamentos.router, anexos.router, calendario.router, ia.router, push.router):
